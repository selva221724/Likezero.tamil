...
To evaluate the model's performance, a test dataset was created with a mix of real and fake news, including some samples generated by ChatGPT.(`I personally prefer utilizing ChatGPT for various tasks. In my view, those who don't leverage AI for productivity are lagging behind by at least a decade in terms of technological advancement`) An inference code was developed to read the test dataset, make predictions, and compare them with the ground truth labels. The accuracy of the model on this test dataset was above 80%, acknowledging potential confusions especially with artificially generated data.
...
## 4. Installation and Running the Scripts
...
```
This will download True.csv, Fake.csv, and Test.csv (created using GPT).
...
I began this assignment amidst personal challenges, leading me to work in various time blocks. On average and overall, I dedicated approximately 8 to 12 hours, spanning multiple training iterations, to complete the task.
